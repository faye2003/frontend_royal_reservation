...
export class PostService {
    ...
    getPosts(page: number, limit: number, data: any): Observable<any> {
        ...
        return this.http.get<any>(this.apiUrl + '/api/post/', option);
    }

    getPostsById(id: number): Observable<any> {
        return this.http.get<any>(this.apiUrl + '/api/post/' + id + '/');
    }

    createPost(post: Post): Observable<any> { // CREATE
        return this.http.post<any>(this.apiUrl + '/api/post/', post);
    }
      

    updatePost(id: number, post: Post): Observable<any> { // UPDATE
        return this.http.put<any>(this.apiUrl + '/api/post/' + id + '/', post);
    }

    deletePost(id: number): Observable<any> { // DELETE
        // console.log(this.apiUrl);
        return this.http.delete<any>(this.apiUrl + '/api/post/' + id + '/');
    }
